...
void InitPeripherals(sPeriphInstances_t *pinst)
{
	...
	InitScuTimerInterrupts(pinst->CoreTimer, PrivateTimerHandler, XPAR_SCUTIMER_INTR);
}
...
//	StartTmrCtrInterrupts(pinst->TmrCtr0Inst);	/* The IC tasks control the tmr ctr interrupts, no need to start them here */
