...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set GPIO_I [ create_bd_port -dir I -from 1 -to 0 GPIO_I ]
  set GPIO_O [ create_bd_port -dir O -from 3 -to 0 GPIO_O ]
...
CONFIG.PCW_ACT_PCAP_PERIPHERAL_FREQMHZ {20.000000} \
CONFIG.PCW_ACT_QSPI_PERIPHERAL_FREQMHZ {99.999999} \
...
CONFIG.PCW_IOPLL_CTRL_FBDIV {3} \
CONFIG.PCW_IO_IO_PLL_FREQMHZ {100.000} \
...
CONFIG.PCW_SDIO_PERIPHERAL_DIVISOR0 {4} \
...
CONFIG.PCW_SPI_PERIPHERAL_DIVISOR0 {100} \
...
CONFIG.PCW_UART0_BAUD_RATE {4800} \
...
CONFIG.PCW_WDT_PERIPHERAL_FREQMHZ {133.333333} \
  ...
  connect_bd_net -net capturetrig0_1 [get_bd_ports capturetrig0] [get_bd_pins axi_timer_0/capturetrig0]
  connect_bd_net -net capturetrig1_1 [get_bd_ports capturetrig1] [get_bd_pins axi_timer_0/capturetrig1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_5M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_5M_interconnect_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins rst_ps7_0_5M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_5M_peripheral_aresetn [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins rst_ps7_0_5M/peripheral_aresetn]
