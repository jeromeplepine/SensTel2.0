...
*              Note: The Res variable holds useful debug information.
*
...
/*
* \brief       Wrapping up the text file before unmounting the file system.
*              Note that this has to be done for any opened file.
*
* \param[in]   file         - File object instance that holds the text file.
*
* \returns     0 if no errors happened, 1 if something went wrong.
*/
{
