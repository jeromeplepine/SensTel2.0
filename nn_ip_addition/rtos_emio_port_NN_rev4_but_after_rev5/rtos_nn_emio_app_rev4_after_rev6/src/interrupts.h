...
#define DRIVER_INST_HANDLER_NUM	3	//Interrupts config sanity check
...
extern TaskHandle_t xPitchControlTask;
extern u32 ulCoreMicroSecondsTicks;
extern volatile u32 PitchSysMode, PitchCmdDone;
extern volatile eSensor_t SystemToZero;
extern volatile u8 CalibSystem;
