...
//#define DEBUG_GEAR_ENC_PRINTS
#define DEBUG_NN_VAL_PRINTS
#define SETZERO_MODS
#define FIXED_PITCH_ZERO
//#define DEBUG_ENABLE_DUMMY_SENSOR_READINGS
//#define IC1_DUMMY_VALUE 1024


/* These two can be overidden independently */
...
//#define SSI_DUMMY_VALUE	4090000
...
#define TURB_FREQ2RPM_CONST	((360.0)/60.0)	/* From Futek's TRD305 spec sheet */
//TODO: Make one big macro with all the equaitons constants
#define AXLE_FREQ2RPM_CONST	(48.0/60.0)	/* From the SKF bearing encoder spec sheet */

/* Torque anbd Thrust related definitions */
#define VOLTS_TO_TORQUE	160.0/4096.0	/* 160 N-m nominal torque vs ADC resolution */
#define	VOLTS_TO_THRUST	1.0

/* Cv7 Weather Station definitions */
#define WDIR_MAX_VAL	360.0

/* Absolute Encoder definitions */
#define PITCH_ABSENC_MAX_VAL	4096
#define FIXD_PITCH_ZERO_VAL		3577992//204.7
//#define FIXD_PITCH_ZERO_VAL		4797835//204.7 + 69.8, FIXED ZERO PITCH UPDATE AT DENHELDER
//#define FIXD_PITCH_ZERO_VAL		0//no offset to recalculate the zero
#define GEAR_ABSENC_MAX_VAL		4096

/* sSensorData_t presets */
#define CV7_WSPD_PROFILE	{0, 0, Cv7_Wspd, NO_AVG, PublicLow, WIND_SPEED_ID, 0}
#define CV7_WDIR_PROFILE	{0, 0, Cv7_Wdir, NO_AVG, PublicLow, WIND_DIRECTION_ID, 0}
#define PITCH_ABSENC_PROFILE	{0, 0, PitchAbsEnc, NO_AVG, PublicLow, ID_PITCH_VALUE, 0}
#define GEAR_ABSENC_PROFILE	{0, 0, GearAbsEnc, NO_AVG, Private, ID_GEAR_VALUE, 0}
#define TURB_INCENC_PROFILE	{0, 0, TurbineIncEnc, COMPUTE_AVG, PublicLow, TURBINE_RPM_ID, 0}
#define AXLE_INCENC_PROFILE	{0, 0, AxleIncEnc, COMPUTE_AVG, PublicLow, WHEEL_RPM_ID, 0}
#define TURB_TORQUE_PROFILE	{0, 0, TurbineTorque, COMPUTE_AVG, Private, 0, 0}
#define THRUST_LOAD_PROFILE	{0, 0, LoadCell, COMPUTE_AVG, Private, 0, 0}
#define SENSOR_TOTAL	8	/* Should match the amount of entries in eSensor */

#define COMPUTE_AVG		1
#define NO_AVG			0
#define ACQMAN_CLRALL	0xFFFFFFFF
#define ACQMAN_HALTSDW	1
...
#define PITSYS_MODE_AUTO		0
#define PITSYS_MODE_MANUAL		1
 ...
 * @param	CalBias is the value acquired upon reception of a calibration command from the
 * 			steering wheel
