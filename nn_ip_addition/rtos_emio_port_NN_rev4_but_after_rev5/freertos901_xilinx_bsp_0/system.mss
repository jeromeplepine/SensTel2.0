...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -Wall -Wextra -O0 -g3
END


BEGIN DRIVER
 PARAMETER DRIVER_NAME = NN
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = NN_1
END
