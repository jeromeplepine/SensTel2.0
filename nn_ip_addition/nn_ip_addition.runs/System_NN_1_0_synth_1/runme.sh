...
HD_PWD='C:/Users/Chinook-ELE/ZynqWorkspace/SensTel2_emio_NNip/nn_ip_addition/nn_ip_addition.runs/System_NN_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log System_NN_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source System_NN_1_0.tcl
